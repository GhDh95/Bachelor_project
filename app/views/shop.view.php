...
<div x-data="{
    ...
    getImagePath(id){
        ...
        if(typeof path == 'undefined'){
            path = '/app/Product_images/not_found.jpg';
        }
        return path;
    },
    ...
    get_empty_img(){
        let path = '/app/Product_images/broken.jpg'; 
        return path; 
    }
    ...
    <form action="" class="grid grid-cols-1 lg:grid lg:grid-cols-4 gap-3 md:grid md:grid-cols-2 mt-10 p-10">
        ...
        <template x-if="product_data.length > 0" x-data="{current_image_path : ''}">
            <template x-for="product in product_data">
                <div id="product" class=" relative grid grid-cols-1 justify-items-center  mb-3">
                    ...
                    <div class="flex flex-col mt-2 justify-self-start pl-2">
                    ...
                    <div class="absolute flex bottom-0 right-0 mr-20 pl-16">
